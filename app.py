...
# 🔐 Берем секретные ключи из файла .env
API_KEY = "AQVN0ZcLew0gqWKyFZWMKN7RUTVP8YnzX8oEVydv"      # 🗝️ Ключ доступа к Яндекс GPT
folder_id = "b1gof6m2ru5t8pqmchi9"  # 📁 ID твоего облака в Яндексе
